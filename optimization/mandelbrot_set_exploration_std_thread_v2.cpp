...
constexpr int X = 5000;       // X of the image
constexpr int Y = 5000;      // Y of the image
...
// Function to compute the Mandelbrot set for a range of rows
...
std::vector<int> computeMandelbrotParallel() {
    ...
    for (int i = 0; i < numThreads; ++i) {
        ...
        threads.emplace_back(computeMandelbrotRows, std::ref(iterations), startRow, endRow);// Add new threads to the vector as you create them
    }
